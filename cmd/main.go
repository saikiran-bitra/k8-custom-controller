...
import (
        ...
        "mydomain.com/m/internal/controller"
...
func main() {
        ...
        mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
                ...
                LeaderElectionID:       "48c13098.mydomain.com",
        ...
        if err = (&controller.PodLogMonitorReconciler{
                Client: mgr.GetClient(),
                Scheme: mgr.GetScheme(),
        }).SetupWithManager(mgr); err != nil {
                setupLog.Error(err, "unable to create controller", "controller", "PodLogMonitor")
                os.Exit(1)
        }
